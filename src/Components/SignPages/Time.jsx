  ...
  return (
    <Box as={Container} maxW="7xl" mt={14} p={4} marginLeft="70px">
      <Flex>
       ...
       <Flex>
        <Box  h="50px" w="100px"><Text>Mon</Text><Text>0:00</Text></Box>
        <Box  h="50px" w="100px"><Text>Tue</Text><Text>0:00</Text></Box>
        <Box  h="50px" w="100px"><Text>Wed</Text><Text>0:00</Text></Box>
        <Box  h="50px" w="100px"><Text>Thr</Text><Text>0:00</Text></Box>
        <Box  h="50px" w="100px"><Text>Fri</Text><Text>0:00</Text></Box>
        <Box  h="50px" w="100px"><Text>Sat</Text><Text>0:00</Text></Box>
        <Box  h="50px" w="100px"><Text>Sun</Text><Text>0:00</Text></Box>
        <Box  h="50px" w="100px" marginLeft="170px"><Text>Week total</Text><Text>6:22</Text></Box>

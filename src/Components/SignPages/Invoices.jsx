  ...
  export default function Invoices() {
    return (
      <Box as={Container} maxW="7xl" mt={14} p={4}>
        ...
        <Box  h="400px" borderColor={"red"}  border="1px" marginTop={"50px"} bg="rgb(239,239,239)"> 
        <Box as={Container} h="200px" marginTop="110px">
            ...
            alt={'product image'}
            src={
              'https://cache.harvestapp.com/static/illustrations/invoices_onboard@2x-70048602.png'
            }
            w="230px"
            marginLeft={"60px"}
            />

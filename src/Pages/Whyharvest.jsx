...
const Whyharvest = () => {
  ...
  return (
    <div className={harvest.harvest_mainContainer}>
     <div className={harvest.harvest_banner}>
     <div className={harvest.banner_hero_img}>
     ...
     <div className={harvest.middle_section}>
        {/* Empower Section */}
        <div className={harvest.empower_section}>
         <div className={harvest.empower_text}>
         ...
         <div className={harvest.empower_image}>
        ...
        {/* Time Tracker */}
        <div className={harvest.Timetrack_section}>
        <div className={harvest.Timetrack_img}>
         ...
         <div className={harvest.Timetrack_text}>
        ...
        <div className={harvest.KeepTrack_section}>
         <div className={harvest.KeepTrack_text}>
         ...
         <div className={harvest.KeepTrack_image}>
        ...
        {/* partner banner */}
        <div className={harvest.Partner_banner}>
     ...
     <div className={harvest.bottom_section}>
         <div className={harvest.bottom_text}>
        ...
        <button onClick={routeTo}>Try Harvest Free</button><p>Free 30-day trial. No credit card required.</p>
         ...
         <div className={harvest.bottom_img}>

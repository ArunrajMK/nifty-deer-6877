...
import styled from '../Styles/Features.module.css'
...
const Features = () => {
  ...
  return (
    <>
    <div className={styled.feature_mainContainer}> 
        <div className={styled.AutoScroll}>
            {/* Scroll Items */}
            <div className={styled.scrollTags}>
                <div className={styled.scroll_items}>
                  ...
                  <h3>Intuitive time tracking and powerful insights that help your team thrive.</h3>
                    <div className={styled.tags}>
                       <div className={styled.tag_item} onClick={()=>handleScroll(timeRef.current)}>
                        ...
                        <div className={styled.tag_item} onClick={()=>handleScroll(reportRef.current)}>
                     ...
                     <div className={styled.tag_item} onClick={()=>handleScroll(invoiceRef.current)}>
                ...
                {/* Items-Section */}
                 <div className={styled.items}>
                    {/* Timetracking */}
                   <div ref={timeRef} className={styled.timetracking}>
                    <div className={styled.timetrack_flex}>
                        <div>
                            <h1>Time tracking </h1>
                            <h3>
                    ...
                    <div className={styled.banner_flex}>
                    <div className={styled.banner_flexitems}>
                      <div>
                 ...
                 {/* banner Genevieve */}
                     <div className={styled.quote_banner}>
                     ...
                     {/* Report & analysis */}
                     <div ref={reportRef} className={styled.report_section}>
                       <div className={styled.report_flexbox}>
                        <div>
                        ...
                        <div>
                         ...
                         {/* banner-flex items */}
                         <div className={styled.report_flex}>
                    <div className={styled.report_flexitems}>
                      <div>
                    ...
                    <div className={styled.report_flexitems}>
                     ...
                     {/* Invoicing & payments */}
                     <div ref={invoiceRef} className={styled.report_section} style={{
                      border:"none"
                     }}>
                       <div className={styled.report_flexbox}>
                        <div>
